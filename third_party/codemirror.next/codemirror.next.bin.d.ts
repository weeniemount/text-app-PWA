...
declare const CodeMirrorNext: {
    readonly commands: {
        readonly defaultKeymap: readonly KeyBinding[];
        readonly deleteLine: Command;
        readonly history: typeof history;
        readonly historyKeymap: readonly KeyBinding[];
        readonly indentMore: StateCommand;
        readonly indentSelection: StateCommand;
        readonly insertNewlineAndIndent: StateCommand;
        readonly insertTab: StateCommand;
    };
    readonly highlight: {
        readonly tags: {
            comment: Tag;
    ...
    readonly language: {
        ...
        readonly indentUnit: Facet<string, string>;
        readonly StreamLanguage: typeof StreamLanguage;
        readonly syntaxHighlighting: typeof syntaxHighlighting;
    };
    readonly search: {
        readonly closeSearchPanel: Command;
        readonly findNext: Command;
        readonly findPrevious: Command;
        readonly openSearchPanel: Command;
        readonly search: typeof search;
        readonly SearchCursor: typeof SearchCursor;
        readonly SearchQuery: typeof SearchQuery;
        readonly selectMatches: Command;
        readonly setSearchQuery: StateEffectType<SearchQuery>;
    };
    readonly state: {
    ...
    readonly view: {
        ...
        readonly keymap: Facet<readonly KeyBinding[], readonly (readonly KeyBinding[])[]>;
